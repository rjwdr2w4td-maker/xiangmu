...
const handleAddPhoto = () => {
  ...
  ElMessage.info('调用相机拍照')
  form.photos.push(`https://coresg-normal.trae.ai/api/ide/v1/text_to_image?prompt=realistic%20agricultural%20field%20inspection%2C%20farmland%20aerial%20view%2C%20rural%20China%2C%20daylight%2C%20documentary%20photo&image_size=landscape_4_3&t=${Date.now()}`)
}
...
const handleSubmit = () => {
  ...
  ElMessageBox.confirm('确认提交随手拍上报吗？', '确认提交', {
    ...
    ElMessage.success('随手拍上报成功，已同步到PC端')
    router.back()
  }).catch(() => {})
}
</script>
